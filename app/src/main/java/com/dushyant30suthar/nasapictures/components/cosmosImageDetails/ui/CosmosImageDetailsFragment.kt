package com.dushyant30suthar.nasapictures.components.cosmosImageDetails.ui
...
import com.dushyant30suthar.nasapictures.databinding.FragmentCosmosImageDetailsBinding
...
class CosmosImageDetailsFragment : BaseFragment(), ActionPerformer<CosmosImageListAction> {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCosmosImageDetailsBinding.inflate(inflater, container, false).apply {
    ...
    * Initial setup*/
    private fun setUpViews() {
        ...
        binding.cosmosImageListRV.layoutManager = LinearLayoutManager(
            context,
            LinearLayoutManager.HORIZONTAL, false
        )
        PagerSnapHelper().attachToRecyclerView(binding.cosmosImageListRV)
